    ...
    @if (! $status || $status === 'rejected')
        <form wire:submit="submit" class="rounded-2xl bg-white border border-gray-200 p-5 sm:p-6 space-y-4">
            <label class="block text-sm">
                ...
                <input type="text" wire:model="storeName" placeholder="e.g. Ahmed Electronics" class="w-full rounded-lg border-gray-300 focus:ring-amber-500" />
            ...
            <label class="block text-sm">
                ...
                <textarea wire:model="description" rows="3" class="w-full rounded-lg border-gray-300 focus:ring-amber-500" placeholder="What do you sell?"></textarea>
            ...
            <div class="grid gap-4 sm:grid-cols-2">
                <label class="block text-sm">
                    ...
                    <input type="text" wire:model="phone" placeholder="+961 70 123456" class="w-full rounded-lg border-gray-300 focus:ring-amber-500" />
